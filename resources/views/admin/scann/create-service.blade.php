            ...
            <div class="p-5">
                ...
                <form class="user" method="POST" action="{{ route('admin.create-service') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <input type="hidden" class="form-input form-control mb-2" name="Cliente_idCliente" value="{{ old('nomeCliente') ?? $client->idCliente }}">                        
                    ...
                    <hr>
                    <div class="form-group row">
                        <button type="submit" name="btnCadServico"
                            class="btn btn-primary btn-sm mr-2 mb-2 ">CADASTRAR</button>
                        <button type="reset" class="btn btn-danger btn-sm ">CANCELAR</button>
                    </div>
                </form>

                <br><button type="submit" class="btn btn-success btn-sm mr-2" id="btnAuxiliar" name="BtnAux"
                    onclick="visibilityCamp()">Funcionario Auxiliar</button><br>
                <button type="submit" class="btn btn-danger btn-sm " id="btnAuxiliar2"
                    onclick="visibilityCamp2()">Cancelar</button>
